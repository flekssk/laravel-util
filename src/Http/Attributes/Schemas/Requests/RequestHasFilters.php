...
use FKS\Http\Attributes\Helpers\RequestFiltersHelper;
...
use FKS\Http\Requests\RuleBuilders\HasEnumFilterValuesInterface;
use FKS\Http\Requests\RuleBuilders\HasSwaggerExampleInterface;
...
trait RequestHasFilters
{
    ...
    public function buildProperty($filtersDefinition): ?Property
    {
        ...
        if (is_a($filtersDefinition, ContainsRuleBuilder::class)) {
            ...
            foreach ($filtersDefinition->getRules() as $rule => $type) {
    ...
    /**
     * @param \FKS\Http\Requests\RuleBuilders\RuleBuilder $filtersDefinition
